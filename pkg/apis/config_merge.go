...
func MergeNetworkConfig(user, cloud *NetworkConfig) *NetworkConfig {
	...
	// If the user did not explicitly request a subinterface, discard any subinterface
	// configuration generated by the cloud provider.
	if user.Interface.SubInterface == nil {
		merged.Interface.SubInterface = nil
	}
